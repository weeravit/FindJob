...
public class FavoriteFragment extends Fragment {
    ...
    private void favoritesShow(final int page) {
        favoriteController.showList(page, LocalStorage.getInstance().getMember());
    }

    @Subscribe
    public void showListSubscribe(FavoriteEvent.ShowList showList) {
