 ...
 */
public class ResumeJobAdapter extends UltimateViewAdapter<ResumeJobAdapter.SearchHolder> {
    ...
    public ResumeJobAdapter(List<Job> searchresults, List<Job> selectedJobs, Context context, int resCustomLayout) {
    ...
    public void onBindViewHolder(SearchHolder holder, int position) {
        try {
            ...
            Job searchResult = searchresults.get(position);
            holder.title.setText(searchResult.getName());
            holder.checkBox.setChecked(false); // Default

            if (SelectedJobs.getInstance().equal(searchResult))
