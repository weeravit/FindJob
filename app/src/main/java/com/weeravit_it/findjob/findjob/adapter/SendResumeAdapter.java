 ...
 */
public class SendResumeAdapter extends UltimateViewAdapter<SendResumeAdapter.MyHolder> {
    ...
    public SendResumeAdapter(List<ResumeBox> resumes, List<ResumeBox> selectedResume, Context context, int resCustomLayout) {
    ...
    public void onBindViewHolder(MyHolder holder, int position) {
        try {
            ...
            if (resumes.get(position) != null) {
                ...
                holder.cbResume.setChecked(false);

                if (selectedResume.contains(resumeBox))
                    holder.cbResume.setChecked(true);
            } else {
                position_item = 0;
            }
    ...
    public class MyHolder extends UltimateRecyclerviewViewHolder {
        ...
        public MyHolder(View itemView, boolean isItem) {
            ...
            if (isItem) {
                ...
                this.cbResume = (CheckBox) itemView.findViewById(R.id.cbResume);
            }
        }
